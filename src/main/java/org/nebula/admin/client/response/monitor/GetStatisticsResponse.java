...
public class GetStatisticsResponse implements Response {
  ...
  public List<StatisticSummary> getStatisticSummaries() {
    return statisticSummaries;
  }

  public void setStatisticSummaries(List<StatisticSummary> statisticSummaries) {
    this.statisticSummaries = statisticSummaries;
  }
}
