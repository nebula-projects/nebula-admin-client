...
public class GetDomainsResponse implements Response {

  private List<DomainSummary> domainSummaries;
  ...
  public void setDomainSummaries(List<DomainSummary> domainSummaries) {
