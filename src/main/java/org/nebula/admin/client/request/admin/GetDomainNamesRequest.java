...
public class GetDomainNamesRequest extends AbstractRequest {

  /**
   * If username is not null, the domain names of the user are queried and the exactMatch is
   * ignored.
   */
  private String username;

  /**
   * fuzzy matching  like domainName% except the excluded domains.
   */
