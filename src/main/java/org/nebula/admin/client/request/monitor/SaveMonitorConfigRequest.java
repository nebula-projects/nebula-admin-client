...
public class SaveMonitorConfigRequest extends AbstractRequest {

  private MonitorConfigSummary monitorConfigSummary;

  public MonitorConfigSummary getMonitorConfigSummary() {
    return monitorConfigSummary;
  }

  public void setMonitorConfigSummary(
      MonitorConfigSummary monitorConfigSummary) {
